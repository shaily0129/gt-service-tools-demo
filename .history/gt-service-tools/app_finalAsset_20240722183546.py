...
from services.service_mission_final_assets.algos.pyreason.algo_mission_final_assets_interaction.AlgoMissionFinalAssetsInteraction import (
    MissionFinalAssetsInteraction,
)

gt-service-tools/services/service_triage_category/algos/pyreason/algo_triage_basic/AlgoMissionFinalAssetsInteraction.py
...
async def mission_final_assets(
    ...
    try:
        ...
        if cached_mission_json is None:
            ...
            cached_mission = MissionOptionsAssets(**cached_mission_json)
