...
if __name__ == "__main__":
    ...
    mission1 = MissionOptionsAssets(patient_name='Benjy Fleming', assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165', 'Ambulance M997A3'], triage_score = 82)
