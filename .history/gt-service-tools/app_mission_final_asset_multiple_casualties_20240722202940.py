...
if __name__ == "__main__":
    ...
    mission = MissionOptionsAssets(patient_name='Julie Trieger', assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165', 'Ambulance M997A3'], triage_score = 84)
