...
class TriageCategoryBasic(Triage):
    ...
    def return_triage_categories(self, patients: list[Patient]) -> list[TriageCategory]:
        ...
        # rules_path = "rules_triage_score_to_triage_category.txt" gt-service-tools/services/service_triage_category/algos/pyreason/algo_triage_basic/rules_triage_score_to_triage_category.txt
