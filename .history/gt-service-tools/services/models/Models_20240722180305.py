...
class MissionFinalAssetsRequest(InteractionRequest):
    id: Optional[str] = None  # Unique identifier for the request

    missions: Optional[List[MissionFinalAssets]] = None
